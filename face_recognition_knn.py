...
if __name__ == "__main__":
    ...
    for image_file in os.listdir("test1"):
        full_file_path = os.path.join("test1", image_file)
        ...
        show_prediction_labels_on_image(os.path.join("test1", image_file), predictions)